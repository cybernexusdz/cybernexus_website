...
const BlogSection = ({ languageCode = "en" }) => {
  ...
  return (
    ...
    <section className="py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 relative" dir={languageCode === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="absolute top-0 right-0 opacity-10 sm:opacity-20">
        ...
        <div className="w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 relative text-primary">
          ...
          <svg viewBox="0 0 400 400" className="w-full h-full">
            ...
            <path d="M200 50 L250 100 L150 100 Z" fill="currentColor" opacity="0.3"/>

            <path d="M350 150 L300 200 L400 200 Z" fill="currentColor" opacity="0.3"/>

            <path d="M50 200 L100 250 L100 150 Z" fill="currentColor" opacity="0.3"/>

            <rect x="150" y="150" width="100" height="100" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.3"/>
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="mb-8 sm:mb-10 md:mb-12">
          ...
          <p className="text-base-content/70 text-base sm:text-lg">{t.blog.subtitle}</p>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-2/3 p-6 sm:p-8 flex flex-col justify-between">
                ...
                <div>
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-base-content mb-3 sm:mb-4">{t.blog.clubNews}</h3>

                  <p className="text-base-content/60 mb-4 sm:mb-6 text-sm sm:text-base">{languageCode === 'ar' ? `Alex، 18 جانفي` : `Alex, 18 January`}</p>

                  <p className="text-base-content/70 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">

                    {languageCode === 'ar' ? 'هذا نص تجريبي لعرض الأخبار الخاصة بالنادي كنموذج مبدئي.' : 'This is a placeholder text to showcase the club news content as an initial sample.'}
            ...
            {articles.map((article, index) => (
              ...
              <div
                ...
                className={`flex-shrink-0 w-full sm:w-80 md:w-96 transition-all duration-500 ${
                  ...
                  index === currentIndex ? 'opacity-100 scale-100' : 'opacity-50 scale-95 hidden sm:block'
              ...
              >
                ...
                <div className="bg-accent/60 backdrop-blur-sm rounded-lg overflow-hidden border border-secondary/20 hover:border-primary/50 transition-all duration-300">
                  ...
                  <div className="p-4 sm:p-5 md:p-6">
                    ...
                    <div className={`${article.tagColor} w-fit px-3 py-1 rounded-full mb-3 sm:mb-4`}>

                      <span className="text-base-100 text-xs sm:text-sm font-semibold">{article.category}</span>

                    </div>

                    {/* Title */}

                    <h3 className="text-xl sm:text-2xl font-bold text-base-content mb-3 sm:mb-4">{article.title}</h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-base-content/60 text-xs sm:text-sm mb-3 sm:mb-4">{languageCode === 'ar' ? `${article.author}، ${article.date}` : `${article.author}, ${article.date}`}</p>

                        <p className="text-base-content/70 text-xs sm:text-sm mb-3 sm:mb-4">{article.excerpt}</p>
