...
export default function CountdownToNov18() {
  ...
  return (
    <div className=" flex flex-col items-center justify-center min-h-[50vh] bg-base-100 text-base-content p-6 rounded-2xl  transition-all duration-300">
      <h2 className="text-3xl md:text-4xl font-bold text-primary mb-6 text-center">
        ⏳ Countdown to November 18
      </h2>
